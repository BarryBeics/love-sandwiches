...
def get_sales_data():
    ...
    by commas. The loop will repeatedly request data, untill it it valid.
    """
    while True:
        print("Please enter sales data from the last market.")
        print("Data should be bix numbers, seperated by commas.")
...
def update_sales_worksheet(data):
    """
    Updated sales worksheet, add new row with the list data provided.
    """
...
def update_surplus_worksheet(data):
    """
    Updated surplus worksheet, add new row with the list data provided.
    """
